                      ...
                      return (
                        <td key={bay} style={{ padding: '0.5rem', width: '30%' }}>
                          <div style={{
                            ...
                            <span style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '0.25rem', fontWeight: 600 }}>🔒 Đã Đóng</span>
                            <span style={{ fontSize: '0.65rem', color: '#cbd5e1' }}>Khung giờ đã qua</span>
                          </div>
                        </td>
                      );
                    }
